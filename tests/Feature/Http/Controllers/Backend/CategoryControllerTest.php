...
class CategoryControllerTest extends TestCase
{
     ...
     * @return void
     */
    public function test_categories_index_page_status(): void
    {
    ...
    public function test_categories_new_resource_is_created()
    {
        ...
        $data = [
          ...
          "slug" => 'deneme_kategorisi-'. $suffix,
        ];
        $response = $this->post('/categories', $data);
        $response->assertRedirect("/categories");
    }
    public function test_categories_existing_category_is_updated()
    {
    ...
    public function test_categories_existing_category_is_deleted()
    {
        $entity = Category::all()->last();
